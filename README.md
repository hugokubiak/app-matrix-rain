...
⚙️ Status: MVP + all charsets + RTL + reduced-motion + hover/click glitch + text-scramble + React wrapper + demo control panel done (canvas + GSAP, script switching wired). Roadmap below.
